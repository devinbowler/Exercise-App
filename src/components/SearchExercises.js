...
const SearchExercises = ({ setExercises, bodyPart, setBodyPart }) => {
  ...
  return (
    <Stack style={{  position: 'relative', zIndex: '1' }} alignItems="center" mt="150px" justifyContent="center" p="20px">
      <Typography fontWeight={700} sx={{ fontSize: { lg: '44px', xs: '30px' } }} mt="300px" mb="49px" textAlign="center">
